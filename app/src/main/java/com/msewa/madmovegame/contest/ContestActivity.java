...
import com.msewa.madmovegame.contest.filter.FilterFrag;
import com.msewa.madmovegame.contest.model.Contest;
import com.msewa.madmovegame.home.model.AllSports;
import com.msewa.madmovegame.payment.PaymentActivity;
import com.msewa.madmovegame.team.TeamActivity;
...
public class ContestActivity extends AppCompatActivity implements ContestFrag.OnContestFragmentInteractionListener, ContestInfo.OnContestInfoFragmentInteractionListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.wallet) {
            getSupportFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, WalletBalanceFrag.newInstance()).commit();
            return true;
        }
    ...
    @Override
    public void openCreateContestFrag() {
        getSupportFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, CreateContestFrag.newInstance()).commit();
    }

    @Override
    public void enterContestFrag() {
        getSupportFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, EnterConstestFrag.newInstance()).commit();
    }

    @Override
    public void openFilterFrag() {
        getSupportFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, FilterFrag.newInstance()).commit();
