...
import com.msewa.madmovegame.contest.adapter.ContestListAdapter;
...
public class ContestFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        createTeamBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mListener.openTeamActivity();
            }
        });
        enterContestBt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.enterContestFrag();
            }
        });
        createContestBt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.openCreateContestFrag();
            }
        });
        ...
        filterBt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.openFilterFrag();
            }
        });

        entryfeeBt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getActivity(), "Entry Fee Clicked", Toast.LENGTH_SHORT).show();
            }
        });

        contestSizeBt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getActivity(), "Contest Size Clicked", Toast.LENGTH_SHORT).show();
    ...
    public interface OnContestFragmentInteractionListener {
        ...
        void openTeamActivity();

        void openCreateContestFrag();

        void enterContestFrag();
